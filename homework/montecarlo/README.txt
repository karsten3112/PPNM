Part A:
Test.txt - contains testing of the plainMC method and a calculation of the integral from the assignment
PlainMC.svg - contains a plot of the estimated error and actual error in a plot to show 1/sqrt(N) scaling
